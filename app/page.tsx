      ...
      <nav className="bg-white shadow-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="hidden md:flex space-x-6">
            <Link href="/lawyers" className="text-gray-600 hover:text-gray-900 transition-colors">
              Find Lawyers
            </Link>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">Connecting clients with the right legal professionals.</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-gray-400">Email: info@lawsphere.com</p>
